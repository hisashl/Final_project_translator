...
exports.ToggleTextButton = void 0;
...
const ToggleTextButton = props => {
  ...
  return /*#__PURE__*/_react.default.createElement(_reactNative.TouchableWithoutFeedback, {
    ...
    style: textStyle
  }, valueName), selected && /*#__PURE__*/_react.default.createElement(_reactNative.View, {
    style: overlayStyle
  })));
};

exports.ToggleTextButton = ToggleTextButton;
