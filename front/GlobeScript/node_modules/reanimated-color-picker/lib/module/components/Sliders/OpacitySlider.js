...
export function OpacitySlider({
  ...
  const activeColorStyle = useAnimatedStyle(() => {
    ...
    const color = HSVA2HSLA_string(hueValue.value, adaptSpectrum ? saturationValue.value : 100, adaptSpectrum ? brightnessValue.value : 100);
    return {
  ...
  const imageStyle = useAnimatedStyle(() => {
    ...
    return {
      ...
      tintColor: HSVA2HSLA_string(hueValue.value, adaptSpectrum ? saturationValue.value : 100, adaptSpectrum ? brightnessValue.value : 100),
      borderRadius,
      transform: [{
        rotate: imageRotate
      }, {
  ...
  const onLayout = ({
    ...
    if (!vertical) width.value = withTiming(layout.width, {
      duration: 5
    });
    if (vertical) height.value = withTiming(layout.height, {
      duration: 5
    });
  };
  ...
  return /*#__PURE__*/React.createElement(GestureDetector, {
    ...
    style: [{
      ...
      borderWidth: 0,
      padding: 0
    }, thicknessStyle, isWeb ? webTransparentTexture : {}]
  }, /*#__PURE__*/React.createElement(RenderNativeOnly, null, /*#__PURE__*/React.createElement(Image, {
    ...
    style: imageStyle,
    resizeMode: "stretch"
  })), /*#__PURE__*/React.createElement(RenderWebOnly, null, /*#__PURE__*/React.createElement(Animated.View, {
    style: [{
      flex: 1,
      borderRadius
    }, activeColorStyle]
