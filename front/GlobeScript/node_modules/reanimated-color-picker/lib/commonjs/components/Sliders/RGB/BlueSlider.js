...
function BlueSlider({
  ...
  const rgb = (0, _reactNativeReanimated.useDerivedValue)(() => {
    return _index.default.runOnUI().RGB({
      h: hueValue.value,
  ...
  }, /*#__PURE__*/_react.default.createElement(_utils.RenderNativeOnly, null, /*#__PURE__*/_react.default.createElement(_reactNativeReanimated.default.Image, {
